...
const FeaturesSliderItem = ({itemNumber, textNumber}) => (
  <div className="features-slider_item">
    <div className="features-img" style={{backgroundImage: `url(${itemNumber})`}}></div>
    <div className="features-feature">{textNumber} целевое преимущество</div>
  </div>
);
          ...
          <div className="features-wrapper">
            ...
            <div className="features-slider">
              <div className="features-slider_items">
                <FeaturesSliderItem  itemNumber={image1} textNumber='Первое'/>
                <FeaturesSliderItem  itemNumber={image2} textNumber='Второе'/>
                <FeaturesSliderItem  itemNumber={image3} textNumber='Третье'/>
                <FeaturesSliderItem  itemNumber={image4} textNumber='Четвертое'/>
              </div>
